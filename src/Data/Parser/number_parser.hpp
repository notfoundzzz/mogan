...
public:
  ...
  inline bool scientific_notation () {
    return bool_features->contains (SCIENTIFIC_NOTATION);
  }
  ...
  inline void support_separator (char param) { separator= param; }
  inline bool is_separator (char param) {
